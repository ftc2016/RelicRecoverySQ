...
@Autonomous(name="Blue2Auto_ENC")
public class Blue2Auto_ENC extends LinearOpMode {
    EncoderMethods blue2 = new EncoderMethods() {
        @Override
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            sleep(1000);
            jewelVertical.setPosition(0.03);
            double power = 0.3;
            ...
            blue2.moveForward(2);
            //slide to cryptobox
            blue2.moveRight(distance);
            blue2.moveForward(0.98);
            //Open Arms
    ...
    //methods for encoder directions
}
