...
public class RTeleOPREA extends OpMode {
    ...
    public void loop() {
        ...
        if (gamepad2.a) {
            //grab glyphs
            servo_rightarmbottom.setPosition(0.6);
            servo_rightarmtop.setPosition(0.5);
            servo_leftarmbottom.setPosition(0.45);
            servo_leftarmtop.setPosition(0.5);
        }
        if (gamepad2.b) {
            //release glyphs
            servo_rightarmbottom.setPosition(0.1);
            servo_rightarmtop.setPosition(0.01);
            servo_leftarmbottom.setPosition(0.89);
            servo_leftarmtop.setPosition(0.89);
        }

        if (gamepad2.x) {
            //release glyphs FOR A LIMITED POSITION
            servo_rightarmbottom.setPosition(0.45);
            servo_rightarmtop.setPosition(0.4);
            servo_leftarmbottom.setPosition(0.6);
            servo_leftarmtop.setPosition(0.2);
        }
